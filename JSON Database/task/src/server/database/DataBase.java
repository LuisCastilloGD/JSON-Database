...
public class DataBase {
    ...
    public void setCellByKey(JsonElement key, JsonElement value) throws KeyMissingException {
    ...
    // TODO: 29/12/2022 Make delete work with key as an array 

    public void deleteCellByKey(JsonElement key) throws KeyMissingException {
        readAndWriteLockController.getWriteLock().lock();
        if (key.isJsonArray()) {
            JsonArray keys = key.getAsJsonArray();
