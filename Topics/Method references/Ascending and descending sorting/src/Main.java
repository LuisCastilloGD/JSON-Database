...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (isAscending) {
            comparator = Main::comparatorAsc;
        } else {
            comparator = Main::comparatorDes;
        }
        sort(array, comparator);
        Arrays.stream(array).forEach(e -> System.out.print(e + " "));
    }

    public static Integer comparatorAsc(Integer a, Integer b) {
        return Math.min(a, b);
    }

    public static Integer comparatorDes(Integer a, Integer b) {
        return Math.max(a, b);
    }
